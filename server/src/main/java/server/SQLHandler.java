...
public class SQLHandler {
    ...
    private static void prepareAllStatements() throws SQLException {
        ...
        psAddMessage = connection.prepareStatement("INSERT INTO message (sender, receiver, text, data) VALUES (\n" +
    ...
    public static boolean addMessage(String sender, String receiver, String text, String data) {
        try {
            psAddMessage.setString(1, sender);
            psAddMessage.setString(2, receiver);
            psAddMessage.setString(3, text);
            psAddMessage.setString(4, data);
        ...
        try {
            ...
            while (rs.next()) {
                ...
                if (receiver.equals("null")) {
                    ...
                    sb.append(String.format("[ %s ] to private [ %s ]: %s \n", sender, receiver, text));
                }
            }
            rs.close();
        } catch (SQLException e) {
